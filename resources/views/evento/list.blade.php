                    ...
                    <table class="min-w-full text-left text-sm font-light">
                        <thead class="border-b border-rose-800 font-medium dark:border-neutral-500">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-4 text-rose-800">Local</th>
                                <th scope="col" class="px-6 py-4 text-rose-800">Data</th>
                        ...
                        <tbody>
                            @foreach ($eventos as $item)
                                ...
                                <tr  
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">{{ $item->categoria_evento->nome ?? '' }}</td>
                                    <td class="whitespace-nowrap px-6 py-4">{{ $item->local->nome ?? '' }}</td>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-rose-800 hover:scale-110 font-semibold hover:opacity-80"><a
                                            href="{{ route('evento.destroy', $item->id) }}"
