...
@section('titulo', 'Listagem de Apresentacoes')
...
<!--<h3 class="pt-4 text-2xl font-medium text-rose-800">Listagem de Apresentacoes</h3>-->
    <div
        ...
        <form action="{{ route('apresentacao.search') }}" method="post">
                        ...
                        <tbody>
                            @foreach ($apresentacoes as $item)
                                ...
                                <tr
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">{{ $item->apresentador->nome ?? '' }}</td>
                                    <td class="whitespace-nowrap px-6 py-4">{{ $item->categoria_apresentacao->nome ?? '' }}</td>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-rose-800 hover:scale-110 font-semibold hover:opacity-80"><a
                                            href="{{ route('apresentacao.edit', $item->id) }}">
                                            <i class="fa-regular fa-pen-to-square"></i> Editar</a></td>
                                    <td class="whitespace-nowrap px-6 py-4 text-rose-800 hover:scale-110 font-semibold hover:opacity-80"><a
                                            href="{{ route('apresentacao.destroy', $item->id) }}"
